...
Page({
  ...
  getStoreList:function(sc_id){
    var that = this;
    server.getJSON("/Store/getStores", { cid: sc_id,city: getApp().globalData.city,},function(res){
            var stores = res.data;
  ...
  goods:function(e){
    ...
    var inke_uid=e.currentTarget.dataset.inke_uid;
    console.log(inke_uid);
    wx.navigateTo({
      url: '../shopVideo/shopVideo?id=' + id+'&inke_uid='+inke_uid,
